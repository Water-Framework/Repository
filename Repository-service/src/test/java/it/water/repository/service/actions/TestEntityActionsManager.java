...
public class TestEntityActionsManager extends StandardActionsManager implements TestEntityActionManager {
    @Override
    public Map<String, DefaultActionList<TestEntity>> getActions() {
        Map<String, DefaultActionList<TestEntity>> actions = new HashMap<>();
